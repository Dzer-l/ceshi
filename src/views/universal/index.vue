...
export default {
	...
	created() {
		this.searchFormData = sessionStorage.searchFormUniversalData ? JSON.parse(sessionStorage.searchFormUniversalData) : this.searchFormData
		this.pageNum = sessionStorage.pageNumUniversal ? Number(sessionStorage.pageNumUniversal) : this.pageNum
		this.pageSize = sessionStorage.pageSizeUniversal ? Number(sessionStorage.pageSizeUniversal) : this.pageSize
	...
	methods: {
		...
		browerStatus() {
			sessionStorage.removeItem("searchFormUniversalData")
			sessionStorage.removeItem("pageNumUniversal")
			sessionStorage.removeItem("pageSizeUniversal")
		},
	},
	beforeRouteLeave(to, from, next) {
		...
		if (toNameList.includes(to.name)) {
			sessionStorage.setItem("searchFormUniversalData", JSON.stringify(this.searchFormData))
			sessionStorage.setItem("pageNumUniversal", this.pageNum)
			sessionStorage.setItem("pageSizeUniversal", this.pageSize)
		}
		next()
	},
